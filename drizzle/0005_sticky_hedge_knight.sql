...
CREATE TABLE "project_configuration" (
	...
	"js_framework" text NOT NULL,
	"css_framework" text NOT NULL,
	"css_options" text NOT NULL,
	"code_style" text NOT NULL,
	"component_naming" text NOT NULL,
...
ALTER TABLE "project_configuration" ADD CONSTRAINT "project_configuration_user_id_user_id_fk" FOREIGN KEY ("user_id") REFERENCES "public"."user"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
...
CREATE INDEX "idx_breakpoint_change_change_type" ON "breakpoint_change" USING btree ("change_type");--> statement-breakpoint
...
CREATE INDEX "idx_project_configuration_user_id" ON "project_configuration" USING btree ("user_id");--> statement-breakpoint
CREATE INDEX "idx_project_configuration_is_template" ON "project_configuration" USING btree ("is_template");--> statement-breakpoint
CREATE INDEX "idx_project_configuration_is_shared" ON "project_configuration" USING btree ("is_shared");--> statement-breakpoint
...
CREATE INDEX "idx_responsive_frame_group_base_name" ON "responsive_frame_group" USING btree ("base_name");